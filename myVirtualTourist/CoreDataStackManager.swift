...
class CoreDataStackManager {
  ...
  lazy var managedObjectModel: NSManagedObjectModel = {
    ...
    let modelURL = Bundle.main.url(forResource: "vtDataModel", withExtension: "momd")!
    
    print("Mode URL : \(modelURL)")
   ...
   */
   ...
   lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
    ...
    let url = self.applicationDocumentsDirectory.appendingPathComponent("myCoreData.sqllite")
    ...
    do {
      ...
      error = NSError(domain: "Virtual Tourist Data Model", code: 9999, userInfo: nil)
